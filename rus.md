...
При формировании списка задач максимально используйте доступные источники информации. Вот
...
В конце нашей работы с Cisco они согласились на 67 задач, которые отражали 
